...
var gameOveri, gameOver, restarti, restart;
...
function setup() {
  ...
  gameOver.addImage("gameOverText", gameOveri);
  gameOver.scale = 0.5;
  gameOver.visible = false;
  
  restart = createSprite(300,140, 20, 20);
  restart.addImage("restartText", restarti);
  restart.scale = 0.5;
...
function spawnObstacles() {
  if(frameCount % 55 === 0) {
    ...
    obstacle.setCollider("rectangle", 0, 0, 40, 80 );
...
function speedUp() {
  ...
  cloudsGroup.velocityX = cloudsGroup.velocityX+2;
}